...
import { Authid, hasuraid, HomePageUrl, ValidPassword, ValidUserid } from '../BridgeUpDotCom/BridgeUpDotComConfig/Homeconfig';
import Homepage from '../BridgeUpDotCom/BridgeUpDotComPageObj/BridgeUpDotComHomePageObj'
/*
AUTHOR: TrackDfect
...
*/
describe('BridgeupDotcom - Test Suite', () => {
    beforeEach(function(){
       // cy.intercept({hostname: Authid}).as('auth');
       // cy.intercept({hostname: hasuraid}).as('hasura');
       // cy.visit(loginTestUrl);
    })
    it(`Test 001:BridgeupDotcom - UI - HomePage - Open Home Page - Testcase-Positive`, () => {  
   ...
   // Loginpage.VerifyDefaultTextForgetpassword()    
    ...
    it(`Test 002:BridgeupDotcom - UI - HomePage - CK Welcome Text - Testcase-Positive`, () => {  
        
        Homepage.VerifyDefaultTextWelcomeBack();
    })

    it(`Test 003:BridgeupDotcom - UI - HomePage - CK Slogan Text - Testcase-Positive`, () => {
       
        Homepage.VerifyDefaultTextSlogan();     
    })
